/* Generated By:JJTree&JavaCC: Do not edit this line. LureParser.java */
  ...
  public class LureParser/*@bgen(jjtree)*/implements LureParserTreeConstants, LureParserConstants {/*@bgen(jjtree)*/
  ...
  static final public SimpleNode ConditionalExpression() throws ParseException {
  ...
  static final public SimpleNode LoopExpression() throws ParseException {
  ...
  static final public void LoopInteriorExpression() throws ParseException {
    Expression();
  }

  static final public void BreakExpression() throws ParseException {
  ...
  static final public void String() throws ParseException {
                 /*@bgen(jjtree) String */
                  ...
                  boolean jjtc000 = true;
                  jjtree.openNodeScope(jjtn000);StringBuilder builder = new StringBuilder();
    try {
    enter("STRING");
  ...
  static final public void StringCharacter(StringBuilder builder) throws ParseException {
                                                      Token t;
  ...
  static final public void FunctionStart() throws ParseException {
  ...
  static final public void FunctionLiteralExpression() throws ParseException {
  ...
  static final public void FunctionInteriorExpression() throws ParseException {
  ...
  static final public void FunctionInvocationExpression() throws ParseException {
  ...
  static public LureParserTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x37e320,0x37e320,0x80,0x37e320,0x37e320,0x400000,0x3e000,0x37e320,0x10000000,0x200000,0x10000000,0x37e320,};
   }
  ...
  public LureParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public LureParser(java.io.InputStream stream, String encoding) {
    ...
    token_source = new LureParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public LureParser(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public LureParser(LureParserTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(LureParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
